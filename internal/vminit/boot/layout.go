...
// checkWriteDisk checks sb, the superblock read on the disk named disk, against the template of
// every write disk: an ext4 labelled spec.WriteLabel. The disks are found by their order and
