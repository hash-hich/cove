...
type Meta struct {
	...
	// SourceDigest names the compressed blob the layer came from, empty for a group.
	...
	// Members is, for a group only, the diff ids of the blobs composed into it, in the order of
	// the manifest.
